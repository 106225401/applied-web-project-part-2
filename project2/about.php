...
<body>
    ...
    <main id="main">
        ...
        <!-- Members Contributions & Details Section -->
        ...
        <section class="gp-pic" aria-labelledby="photo-heading">
            ...
            <div class="gallery">
                <figure class="pic1">
                    <label for="img2">
                        <img src="images/gpic1.jpeg"
                             alt="Our team members selfie at Bingxue - free style picture 1"
                             loading="lazy">
                    </label>
                    <figcaption>
                        1/3 - Meeting at Bingxue; Selfie 1
