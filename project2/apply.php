 ...
 *  Author: Jingyee (Ng Jing Yee) – Organizer & Developer
 *  Individual Responsibility: apply.php
 *  =====================================================
 *
 *  Description:
 *  Online job application form for position applications.
 *  Collects applicant details, selected job reference,
 *  and professional skills.
 *  
 *  Form Action: Mercury form test URL
 *  
...
<body>
    ...
    <main id="main">
        ...
        <!-- Form Section Navigation (Anchor Links) -->
        ...
        <form id="application-form"
            ...
            <section id="job" class="form-section" aria-labelledby="job-title">
                ...
                <span class="error-text">
                    Please enter a valid job reference number (refer to the available positions).
                </span>
            ...
            <section id="applicant-details" class="form-section" aria-labelledby="details-title">
                ...
                <fieldset>
                    ...
                    <input type="text"
                           ...
                           required>
                    <span class="error-text">
                        Please enter up to 20 letters only (no numbers or symbols).
                    </span>
                    ...
                    <!-- Gender Selection (Nested Fieldset) -->
                    <fieldset>
            ...
            <section id="skills" class="form-section" aria-labelledby="skills-title">
                ...
                <fieldset>
                    ...
                    <div class="skill-item">
                        ...
                        <label for="other">Other skills&hellip;</label>
                    </div>
